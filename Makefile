...
SOURCES=AudioDev.c AudioEffects.c AudioMic.c AudioMixer.c AudioPipe.c AudioSpk.c BiQuad.h BiQuad.c VideoPlayer.c VideoPlayerWidgets.c VideoQueue.c YUV420RGBgl.c Cover.c
OBJECTS=$(SOURCES:.c=.o)
EXECUTABLE=Cover
